...
parameter_min_samples_leaf= st.sidebar.slider('Minimum number of samples required to be a leaf node (min_samples_leaf)', 1, 10, 2, 1)
...
def build_model(df):
    ...
    st.write('Coefficient of determintaion ($R^2$):')
